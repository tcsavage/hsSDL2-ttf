...
fontStyleToC :: FontStyle -> CUInt
fontStyleToC StyleBold      = #{const TTF_STYLE_BOLD}
fontStyleToC StyleItalic    = #{const TTF_STYLE_ITALIC}
fontStyleToC StyleUnderline = #{const TTF_STYLE_UNDERLINE}

cToFontStyle :: CUInt -> FontStyle
cToFontStyle #{const TTF_STYLE_BOLD}      = StyleBold
cToFontStyle #{const TTF_STYLE_ITALIC}    = StyleItalic
cToFontStyle #{const TTF_STYLE_UNDERLINE} = StyleUnderline
...
getFontStyle font
    = withForeignPtr font $
      fmap (fromBitmask fontStyleToC . fromIntegral) . ttfGetFontStyle
...
setFontStyle font style
    = withForeignPtr font $ \fontPtr ->
      ttfSetFontStyle fontPtr (fromIntegral . toBitmask fontStyleToC $ style)
