...
foreign import ccall unsafe "TTF_RenderText_Solid_Ptrd" ttfRenderTextSolid
...
foreign import ccall unsafe "TTF_RenderUTF8_Solid_Ptrd" ttfRenderUTF8Solid
    :: Ptr FontStruct -> CString -> Ptr Color -> IO (Ptr SurfaceStruct)
...
foreign import ccall unsafe "TTF_RenderGlyph_Solid_Ptrd" renderGlyphSolid
...
foreign import ccall unsafe "TTF_RenderText_Shaded_Ptrd" ttfRenderTextShaded
...
foreign import ccall unsafe "TTF_RenderUTF8_Shaded_Ptrd" ttfRenderUTF8Shaded
    :: Ptr FontStruct -> CString -> Ptr Color -> Ptr Color -> IO (Ptr SurfaceStruct)
...
foreign import ccall unsafe "TTF_RenderGlyph_Shaded_Ptrd" renderGlyphShaded
...
foreign import ccall unsafe "TTF_RenderText_Blended_Ptrd" ttfRenderTextBlended
    :: Ptr FontStruct -> CString -> Ptr Color -> IO (Ptr SurfaceStruct)
...
foreign import ccall unsafe "TTF_RenderUTF8_Blended_Ptrd" ttfRenderUTF8Blended
    :: Ptr FontStruct -> CString -> Ptr Color -> IO (Ptr SurfaceStruct)
...
foreign import ccall unsafe "TTF_RenderGlyph_Blended_Ptrd" renderGlyphBlended
    :: Ptr FontStruct -> Word16 -> Ptr Color -> IO (Ptr SurfaceStruct)
